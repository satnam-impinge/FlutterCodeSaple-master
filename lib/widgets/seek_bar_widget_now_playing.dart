...
class SeekBarNowPlay extends StatefulWidget {
...
class _SeekBarState extends State<SeekBarNowPlay> {
  double? _dragValue;
  late SliderThemeData _sliderThemeData;

  bool get isVisible => widget.isVisible != null;

   get activeTrackColor => widget.activeTrackColor;
  get inactiveTrackColor => widget.inactiveTrackColor;

  get trackHeight => widget.trackHeight;

  bool get topTimerVisible => widget.topTimerVisible != null;
    ...
    return Container(
      child: Column(
        children: [
          ...
          Visibility(
              visible:!topTimerVisible &&!isVisible,
              child: Padding(padding: EdgeInsets.only(top: 10, left: 10, right: 10, bottom: 5),
